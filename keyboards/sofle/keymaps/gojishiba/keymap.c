 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |  ~   | LGUI | LAlt |LOWER | /Space  /       \ Bspc \  |RAISE | RCTR |   -  |   +  |
 *            |  `   |      |      |      |/       /         \      \ |      |      |      |   =  |
 *             `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_ENT, \
                 KC_GRV ,KC_LGUI, KC_LALT, KC_LOWER, KC_SPC,      KC_BSPC,  KC_RAISE, KC_RCTRL, KC_MINS, KC_EQL \
),
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | LAt  | LCtl |LShift|      | Caps |-------.    ,-------|      | Left | Down | Rigth|  Del | PgUp |
 * |------+------+------+------+------+------|  MPLY |    |       |------+------+------+------+------+------|
 * |      | Undo |  Cut | Copy | Paste|      |-------|    |-------|      | LStr |      | LEnd |      | PgDn |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |      |      |      |      | /       /       \ Bspc \  |      |      |      |      |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *             `----------------------------------'           '------''---------------------------' 
...
[_RAISE] = LAYOUT( \
  ...
  _______, KC_LALT,  KC_LCTL,  KC_LSFT,  XXXXXXX, KC_CAPS,                       KC_PGDN,  KC_LEFT, KC_DOWN, KC_RGHT,  KC_DEL, KC_PGUP, \
  _______,KC_UNDO, KC_CUT, KC_COPY, KC_PASTE, XXXXXXX,  KC_MPLY,       _______,  XXXXXXX, KC_LSTRT, XXXXXXX, KC_LEND,   XXXXXXX, KC_PGDOWN, \
                         _______, _______, _______, _______, _______,       KC_BSPC, _______, _______, _______, _______ \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
#define TAP_FRAMES 2
#define TAP_SPEED 65 // above this wpm value typing animation to triggere
